...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public XmlReaderContext createReaderContext(Resource resource) {
		...
		//
		// 其中 namespaceHandlerResolver 会创建默认的 DefaultNamespaceHandlerResolver，
		// DefaultNamespaceHandlerResolver的handlerMappingsLocation 属性会使用默认的值
		// “META-INF/spring.handlers”，并且这边有个重要的属性 handlerMappings，handlerMappings
		// 用于存放命名空间和该命名空间handler类的映射，如下图：
